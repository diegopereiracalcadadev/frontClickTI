    ...
    return (
      <nav className="topbar">
        ...
        <ul id="slide-out" className="sidenav">
          ...
          <li>
            <a module="openos" onClick={this.activateModule(Modulo.OpenOS)} className="waves-effect" href="#!">Abrir Chamado (Em Breve)</a>
          </li>
          <li>
            <a module="closeos" onClick={this.activateModule(Modulo.OpenOS)} className="waves-effect" href="#!">Chamados Abertos</a>
          </li>
        </ul>
      </nav>
    );
