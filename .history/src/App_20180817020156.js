...
class App extends React.Component {
  ...
  setActiveModule(nextModule){
    console.log("entrou no setActiveModule", nextModule);
...
class Header extends React.Component {
  ...
  activateModule (module){
    ...
    this.props.setActiveModule(this.state);

    //changeModule(module);document.getElementsByClassName("sidenav-overlay")[0].click();
  }
    ...
    return (
      <nav className="topbar">
        ...
        <ul id="slide-out" className="sidenav">
          ...
          <li>
            <a onClick={this.activateModule.bind(null, Modulo.OPENOS)} className="waves-effect" href="#!">Abrir Chamado (Em Breve)</a>
          </li>
          <li>
            <a onClick={this.activateModule.bind(null, Modulo.CLOSEOS)} className="waves-effect" href="#!">Chamados Abertos</a>
          </li>
        </ul>
      </nav>
    );
