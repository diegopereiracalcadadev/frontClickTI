    ...
    return (
      <nav className="topbar">
        ...
        <ul id="slide-out" className="sidenav">
          ...
          <li>
            <a onClick={this.activateModule.bind(Modulo.OPENOS)} className="waves-effect" href="#!">Abrir Chamado (Em Breve)</a>
          </li>
          <li>
            <a onClick={this.activateModule.bind(Modulo.CLOSEOS)} className="waves-effect" href="#!">Chamados Abertos</a>
          </li>
        </ul>
      </nav>
    );
