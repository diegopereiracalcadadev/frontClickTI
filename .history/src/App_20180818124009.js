  ...
  render() {
    return (
      <div>
        ...
        */}
        <Header changeAppActiveModule = {this.changeAppActiveModule} />
        <Body />
        <Footer />
      </div>
    );
...
class Header extends React.Component {
  ...
  constructor(props) {
    ...
    // TEM QUE FAZER O BIND PARA PODER USAR O THIS.PROPS
    this.handleMenuItemOnClick = this.handleMenuItemOnClick.bind(this);
  }

  handleMenuItemOnClick(moduleKey){
    console.log("[HEADER] - setActiveModule invocado com param: ", moduleKey);
    this.props.changeAppActiveModule(moduleKey);
    ...
    return (
      <nav className="topbar">
        ...
        <ul id="slide-out" className="sidenav">
          ...
          <li>
            <a onClick={this.handleMenuItemOnClick.bind(null, Modulo.OPENOS.key)} className="waves-effect" href="#!">Abrir Chamado (Em Breve)</a>
          </li>
          <li>
            <a onClick={this.handleMenuItemOnClick.bind(null, Modulo.CLOSEOS.key)} className="waves-effect" href="#!">Chamados Abertos</a>
          </li>
        </ul>
      </nav>
    );
